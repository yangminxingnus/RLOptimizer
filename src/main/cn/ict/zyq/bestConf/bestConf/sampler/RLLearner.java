...
public class RLLearner extends ConfigSampler{
	...
	public static void main(String[] args){
		...
		RLLearner sampler = new RLLearner();
	...
	private static int[] getOneDimInt(int minX, int maxX, int sampleSetSize){
	...
	private static double[] getOneDimDouble(double minX, double maxX, int sampleSetSize){
